...
jest.mock('./components/Calendar/EventSidebar', () => function EventSidebarMock() {
  return <div>Event Sidebar</div>;
});
...
jest.mock('./components/Groups/Groups', () => function GroupsMock({ onSelectGroup }) {
  return (
    <div>
